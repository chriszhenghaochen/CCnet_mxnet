...
def train_net(args, ctx, pretrained, epoch, prefix, begin_epoch, end_epoch,
    ...
    if args.resume:
        ...
        if args.network == 'resnet':
            arg_params['bn_roi_pool5_1_gamma'] = mx.nd.ones(shape=arg_shape_dict['bn_roi_pool5_1_gamma'])
            arg_params['bn_roi_pool5_1_beta'] = mx.nd.zeros(shape=arg_shape_dict['bn_roi_pool5_1_beta'])
            arg_params['bn_roi_pool5_2_gamma'] = mx.nd.ones(shape=arg_shape_dict['bn_roi_pool5_2_gamma'])
            arg_params['bn_roi_pool5_2_beta'] = mx.nd.zeros(shape=arg_shape_dict['bn_roi_pool5_2_beta'])
            arg_params['bn_roi_pool5_3_gamma'] = mx.nd.ones(shape=arg_shape_dict['bn_roi_pool5_3_gamma'])
            arg_params['bn_roi_pool5_3_beta'] = mx.nd.zeros(shape=arg_shape_dict['bn_roi_pool5_3_beta'])
            arg_params['cls_score1_weight'] = mx.random.normal(0, 0.01, shape=arg_shape_dict['cls_score1_weight'])
            arg_params['cls_score1_bias'] = mx.nd.zeros(shape=arg_shape_dict['cls_score1_bias'])
            arg_params['cls_score2_weight'] = mx.random.normal(0, 0.01, shape=arg_shape_dict['cls_score2_weight'])
            ...
            aux_params['bn_roi_pool5_2_moving_var'] = mx.nd.ones(shape=aux_shape_dict['bn_roi_pool5_2_moving_var'])
            aux_params['bn_roi_pool5_3_moving_mean'] = mx.nd.zeros(shape=aux_shape_dict['bn_roi_pool5_3_moving_mean'])
            aux_params['bn_roi_pool5_3_moving_var'] = mx.nd.ones(shape=aux_shape_dict['bn_roi_pool5_3_moving_var'])
    ...
    #debug
    # print(sym.get_internals()['bn1_moving_mean'].attr_dict() )
